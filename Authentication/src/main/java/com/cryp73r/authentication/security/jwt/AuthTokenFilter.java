package com.cryp73r.authentication.security.jwt;

import com.cryp73r.authentication.exception.BadCredentialsException;
import com.cryp73r.authentication.exception.JwtAuthenticationException;
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                if (!userDetails.isEnabled()) throw new BadCredentialsException("Account is not enabled");
